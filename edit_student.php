...
if(!isset($_FILES['image']['tmp_name']))
{
	...
	if($picture == "")
	{
		...
		if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
			...
			$query = "UPDATE records SET firstname='".$getfirstname."',lastname='".$getlastname."',mi='".$getmi."',subject='".$getsubject."',picture='".$picture."',first_grading='".$getfirst."',second_grading='".$getsecond."',third_grading='".$getthird."' where id='".$id."'";
							...
							<th width="50%" style="border-bottom: 2px solid;">
								<table width="100%">
									...
									<tr>
										...
										<td><input type="text" name="subject" value="<?php echo $getsubject;?>" required></td>
									</tr>
									<tr>
									...
									<tr>
										<th style="text-align: left;padding-left: 20px;">Finals: </th>

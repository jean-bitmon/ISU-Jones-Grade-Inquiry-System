				...
				<th>
					<table width="100%" cellspacing="0">
						...
						<tr>
							...
							<th width="15%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Subject</th>
							<th width="7%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Prelim</th>
							<th width="7%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Midterm</th>
							<th width="7%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Finals</th>
						...
						while($row = mysql_fetch_array($result)){
							...
							$final_grade = ($first_grading + $second_grading + $third_grading) / 3;
							if($final_grade<=5.00){
								$remarks = "PASSED";	
							} else {
								$remarks = "FAILED";
						...
						<tr>
							...
							<th style="background-color: #efb295;border-bottom: 1px solid;"><?php echo "$subject";?></th>

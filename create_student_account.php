...
if(!isset($_FILES['image']['tmp_name']))
{
	...
	if($picture == "")
	{
		...
		if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
			...
			$query = "INSERT INTO records(id,teacher_number,firstname,lastname,mi,subject,picture,first_grading,second_grading, third_grading,fourth_grading,final_grade,remarks) VALUES (null,'".$teacher_id."','".$firstname."','".$lastname."','".$mi."','".$subject."','".$picture."','".$first_grading."','".$second_grading."','".$third_grading."','".$fourth_grading."','".$final_grade."','".$remarks."')";
							...
							<th width="50%" style="border-bottom: 2px solid;">
								<table width="100%">
									...
									<tr>
										...
										<td><input type="text" name="subject" value="<?php echo '';?>" required></td>
									</tr>
									<tr>
